...
feat_4,train_4 = feat_model.read_file('feature_4_seg2','train_4_seg2',0)
feat_5,train_5 = feat_model.read_file('feature_5_seg2','train_5_seg2',0)
feat_6,train_6 = feat_model.read_file('feature_6_seg2','train_6_seg2',0)
...
del feat_3,feat_4,feat_5,feat_7_p
#-训练集
...
del train_3,train_4,train_5,train_7_p
print("完成！",train_3_4_5_6_p7.shape)
'''
#====================================================模型==========================================================
#--训练集提取特征
#train_3_4_5 = feat_model.get_feat(feat_3_4_5,train_3_4_5)
#train_3_4_5.to_csv('/home/wangxuefei/Downloads/data/train_3_4_5_before_spilt_point.txt', index=False)
#del train_3_4_5
#train_4_5_6 = feat_model.get_feat(feat_4_5_6,train_4_5_6)
#train_4_5_6.to_csv('/home/wangxuefei/Downloads/data/train_4_5_6_before_spilt_point.txt', index=False)
#del train_4_5_6
...
#train_6.to_csv('/home/wangxuefei/Downloads/data/train_6_end.txt',index=False)
#del feat_6,train_6
#train_7 = feat_model.get_feat(feat_7,train_7)
#train_7.to_csv('/home/wangxuefei/Downloads/data/train_7_end.txt',index=False)
#del feat_7,train_7
#=============================================划分训练集================================================================
#====================================================模型==============================================================
#----横向拼接
#train_456_345_fuse = feat_model.confuse_col('train_4_5_6_before_spilt_point','train_3_4_5_before_spilt_point',1)
#train_456_345_fuse.to_csv('/home/wangxuefei/Downloads/data/train_456_345_fuse.txt',index=False)

#train_7_6_fuse = feat_model.confuse_col('train_7_end','train_6_end',1)
#train_7_6_fuse.to_csv('/home/wangxuefei/Downloads/data/train_7_6_fuse_end.txt',index=False)
#del train_7_6_fuse
#-训练集去噪，并存文件
#train_456_345_fuse = feat_model.To_file_remove_noise_point(train_456_345_fuse)
#train_456_345_fuse.to_csv('/home/wangxuefei/Downloads/data/train_456_345_fuse_end.txt', index=False)
#del train_456_345_fuse
...
#train_3_4_5_6_p7.to_csv('/home/wangxuefei/Downloads/data/train_3_4_5_6_p7_end.txt', index=False)
#del train_3_4_5_6_p7
#=========================================================训练==========================================================

#------------线上七月--------
#-----需要注意文件名-------
#--模型1
#feat_model.XGB_train('train_456_345_fuse','train_7_6_fuse_end',"on",915,1)
#--模型2
#feat_model.XGB_train('train_3_4_5_6_p7_end','train_7_end',"on",915,1)
#--模型3
#lgbxgb.LGBM_train('train_456_345_fuse','train_7_6_fuse_end',915,"on")
#--模型4
#lgbxgb.LGBM_train('train_3_4_5_6_p7_end','train_7_end',915,"on")
#--模型融合
