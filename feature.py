...
link_info = pd.read_csv('/home/wangxuefei/Downloads/pre_data/gy_contest_link_info.txt',sep=';',low_memory=False)
link_info = link_info.sort_values('link_ID')
#print(link_info.info())
training_data = pd.read_csv('/home/wangxuefei/Downloads/pre_data/quaterfinal_gy_cmp_training_traveltime.txt',sep=';',header= 0 ,low_memory=False)
...
testing_data = pd.read_csv('/home/wangxuefei/Downloads/pre_data/submition_template_seg2.txt',sep=';',low_memory=False)
#=======预测数据+道路基本信息合成======
...
feature_date.to_csv('/home/wangxuefei/Downloads/pre_data/feature_data.txt',index=False)
del feature_date

feature_data = pd.read_csv('/home/wangxuefei/Downloads/pre_data/feature_data.txt',low_memory=False)
feature_data_date = TimeFeature(feature_data)
print("==============时间分离以后，行列数==========",feature_data_date.shape)
print(feature_data_date.info())
del feature_data
feature_data_date.to_csv('/home/wangxuefei/Downloads/pre_data/data_after_handle.txt',index=False)
del feature_data_date
feature_data = pd.read_csv('/home/wangxuefei/Downloads/pre_data/data_after_handle.txt',low_memory=False)
...
feature_data_basic_week.to_csv('/home/wangxuefei/Downloads/pre_data/feature_data_basic_week.txt',index=False)
del feature_data_basic_week
feature_data = pd.read_csv('/home/wangxuefei/Downloads/pre_data/feature_data_basic_week.txt',low_memory=False)
link_info_handle = pd.read_csv('/home/wangxuefei/Downloads/data/link_info_handle.txt',low_memory=False)
feature_data = pd.merge(feature_data, link_info_handle, on='link_ID', how='left')
print("==============加入上个路口信息后行列数==========",feature_data.shape)

print(feature_data.head)
del link_info_handle
#==4月
...
feature_4.to_csv('/home/wangxuefei/Downloads/data/feature_4_seg2.txt',index=False,)
...
train_4.to_csv('/home/wangxuefei/Downloads/data/train_4_seg2.txt',index=False)
...
feature_5.to_csv('/home/wangxuefei/Downloads/data/feature_5_seg2.txt',index=False)
...
train_5.to_csv('/home/wangxuefei/Downloads/data/train_5_seg2.txt',index=False)
...
feature_6.to_csv('/home/wangxuefei/Downloads/data/feature_6_seg2.txt',index=False)
...
train_6.to_csv('/home/wangxuefei/Downloads/data/train_6_seg2.txt',index=False)
...
feature_7.to_csv('/home/wangxuefei/Downloads/data/feature_7_seg2.txt',index=False)
...
train_7.to_csv('/home/wangxuefei/Downloads/data/train_7_seg2.txt',index=False)
